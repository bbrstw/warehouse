...
class WhousesControllerTest < ActionController::TestCase
  ...
  test "should create whouse" do
    assert_difference('Whouse.count') do
      post :create, whouse: { account_id: @whouse.account_id, code: @whouse.code, description: @whouse.description, name: @whouse.name }
    end
  ...
  test "should update whouse" do
    patch :update, id: @whouse, whouse: { account_id: @whouse.account_id, code: @whouse.code, description: @whouse.description, name: @whouse.name }
    assert_redirected_to whouse_path(assigns(:whouse))
  end
